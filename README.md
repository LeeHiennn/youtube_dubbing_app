...
**4. Xác thực YouTube (Tùy chọn nhưng khuyên dùng)**
Do YouTube dạo này kiểm soát rất gắt gao bot tự động tải video, để tải được video dài ổn định, hãy tạo một file `cookies.txt` (được trích xuất từ trình duyệt của bạn đang đăng nhập YouTube qua tiện ích "Get cookies.txt LOCALLY") và đặt ở thư mục gốc của dự án.
## 🚀 Hướng dẫn sử dụng
